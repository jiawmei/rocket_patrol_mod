class Play extends Phaser.Scene {
    ...
    create() {
        ...
        // add Spaceships (x3)
        //super fast ship worth more points
        this.ship01 = new Spaceship(this, game.config.width + borderUISize*6, borderUISize*4, 'newship', 0, 75, 10).setOrigin(0, 0);
